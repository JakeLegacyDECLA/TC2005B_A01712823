...
const ruta_new = require('./new.routes');
const ruta_gwen = require('./gwen.routes');
const ruta_mordekaiser = require('./mordekaiser.routes');
const ruta_jax = require('./jax.routes');
...
router.use('/gwen', ruta_gwen);
router.use('/mordekaiser', ruta_mordekaiser);
router.use('/jax', ruta_jax);
router.use('/new', ruta_new);
...
router.get('/', (request, response) => {
  let html_index = `
    ...
    <a href="/personajes/new">Crear nuevo campeón</a><br>
    <a href="/equipos">Equipos en Lol</a><br>
    <a href="/personajes/gwen">Información de Gwen</a><br>
    <a href="/personajes/mordekaiser">Información de Mordekaiser</a><br>
    <a href="/personajes/jax">Información de Jax</a><br><br>
  ...
  for (let personaje of personajes) {
    html_index += `
      <div style="margin-bottom:18px;">
        ...
        <img class="is-rounded" src="${personaje.imagen}" style="max-width:420px;width:100%;border-radius:10px;" />
      </div>
    `;
  }
